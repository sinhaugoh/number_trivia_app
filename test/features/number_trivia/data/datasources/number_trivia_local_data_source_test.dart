...
void main() {
  ...
  group('getLastNumberTrivia', () {
    final tNumberTrivia = NumberTriviaModel.fromJson(json.decode(fixture('trivia_cached.json')));
    test(
      'should return a NumberTrivia from SharedPreferences if there is one in the cache',
          () async {
        //arrange
    ...
    test(
      'should throw CacheException when there is not a cached value',
        ...
        when(mockSharedPreferences.getString(any))
            .thenReturn(null);
        //act
        final result = numberTriviaLocalDataSourceImpl.getLastNumberTrivia;
        //assert
  ...
  group('cacheNumberTrivia', () {
    ...
    test(
      'should store NumberTriviaModel into SHaredPreferences',
          () async {
        //act
