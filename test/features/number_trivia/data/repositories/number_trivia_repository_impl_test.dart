...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestOnline(() {
      ...
      test('should cache the data locally when the call to the remote data source is successful', () async {
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
            .thenAnswer((_) async => tNumberTriviaModel);
      ...
      test('should return server failure when the call to the remote data source is unsuccessful', () async {
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
